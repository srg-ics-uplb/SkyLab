...
urlpatterns = [
    ...
    url(r'^use_gamess$', views.GamessView.as_view(), name='use_gamess'),
    url(r'^ray/ray$', views.RayView.as_view(), name='use_ray'),
    url(r'^vina/vina$', views.VinaView.as_view(), name="use_vina"),
    url(r'^vina/vina_split', views.VinaSplitView.as_view(), name="use_vina_split"),
